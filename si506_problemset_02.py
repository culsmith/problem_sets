...
great_wall = china_unesco_sites[9]
print(great_wall)
...
great_wall_item_length = [len(item) for item in great_wall_list]
...
listoflists = []
unesco_sites = []
for items in china_unesco_sites:
    listoflists.append(list(items.split(',')))

for item in listoflists:
   if item[2] == 'Cultural':
      listoflists[listoflists.index(item)]
      unesco_sites.append(f"{item[0]} - {item[1]} - {item[3]}")
print(unesco_sites)
